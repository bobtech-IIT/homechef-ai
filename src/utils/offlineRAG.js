...
import { OFFLINE_RECIPES, checkIfVegetarian } from './offlineKnowledgeBase'; // we will also export the big lists from data files
...
export function saveCustomRAGChunk(name, text, region = 'Indian', diet = 'veg') {
  ...
  try {
    ...
    const customRecipe = {
      ...
      name,
      region,
      isVegetarian: checkIfVegetarian(name, text),
