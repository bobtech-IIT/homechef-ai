...
import { X, Search, Sparkles, MapPin, ChefHat, Heart, Compass } from 'lucide-react';
    ...
    <div style={{
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
          <Compass className="animate-spin-slow" size={24} style={{ color: 'var(--primary-saffron)' }} />
          <div>
        ...
        {!isZoomed ? (
          <>
            ...
            <div style={{
              padding: '16px',
              borderRadius: '12px',
              background: 'linear-gradient(135deg, rgba(211, 84, 0, 0.1) 0%, rgba(211, 84, 0, 0.02) 100%)',
              border: '1px dashed var(--primary-saffron)',
              display: 'flex',
              alignItems: 'center',
              gap: '12px'
            }}>
              <Sparkles size={24} style={{ color: 'var(--primary-saffron)', flexShrink: 0 }} />
                        ...
                        return (
                          ...
                          >
                            <span style={{ fontSize: '13px', fontWeight: 800, color: '#FFFFFF', display: 'flex', alignItems: 'center', gap: '4px' }}>
                              <MapPin size={12} style={{ color: isUT ? 'var(--secondary-turmeric)' : 'var(--primary-saffron)', flexShrink: 0 }} />
                              {state}
                            </span>
          ...
          <div className="fade-in-slide" style={{
            ...
            <div style={{
              ...
              height: '160px',
              borderRadius: '50%',
              background: 'radial-gradient(circle, rgba(211, 84, 0, 0.15) 0%, rgba(30, 20, 15, 0) 70%)',
              border: '2px dashed var(--primary-saffron)',
              display: 'flex',
              alignItems: 'center',
              justifyContent: 'center',
              position: 'relative',
              boxShadow: '0 0 20px rgba(211, 84, 0, 0.1)'
            }}>
              <MapPin size={40} className="animate-bounce" style={{ color: 'var(--primary-saffron)' }} />
              <div style={{
                position: 'absolute',
                bottom: '-10px',
